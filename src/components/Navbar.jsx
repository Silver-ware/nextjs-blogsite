...
function Navbar(props) {
  ...
  return (
    ...
    <div className="w-full bg-[#ffffff57] h-max text-white pt-[25px] px-9 pb-[20px] fixed
      ...
      <ul className="flex flex-1 min-w-[500px] px-[38px] gap-[25px] justify-end">
        <li className="border-b-[3px] border-[#050D1B] cursor-pointer
          p-[10px] flex items-center text-[28px] font-semibold text-white"
          onClick={() => navigateTo("/")}>Home</li>
        <li className="border-b-[3px] border-[#D8C4B6BF] cursor-pointer
