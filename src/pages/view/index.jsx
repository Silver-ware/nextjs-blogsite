...
export default function index() {
  return (
    <div className="bg-gradient-to-b from-white from-[80%] to-[#3E5879] w-full h-[1024px] flex flex-col">
        <div className="flex items-end w-full h-full bg-black bg-[url(https://images.unsplash.com/photo-1542662565-7e4b66bae529?q=80&w=1527&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] bg-center bg-cover">
            <div className="w-full flex justify-center text-white p-[10px] gap-[10px]">
                <div className="px-[10px] bg-white bg-opacity-[25%] py-[3px] cursor-pointer">Mountain</div>
                <div className="px-[10px] bg-white bg-opacity-[25%] py-[3px] cursor-pointer">Scenery</div>
                <div className="px-[10px] bg-white bg-opacity-[25%] py-[3px] cursor-pointer">Nature</div>    
            </div>
        </div>  
        <div className="w-full h-full flex flex-col px-[40px] gap-[10px] py-[25px] text-[#213555]">
            ...
            <div  className="w-full p-[10px] flex items-center">
                <Link href={'/'} className="text-[40px] font-semibold underline underline-offset-[18%]">View Other Blogs</Link>
            </div>
        </div>
    </div>
  )
